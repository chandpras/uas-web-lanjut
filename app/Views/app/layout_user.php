...
?>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/user" class="logo d-flex align-items-center">
        <span class="bi bi-eye-fill" style="margin: 5px;"></span>
        <span class="d-none d-lg-block">OptiCare</span>
      </a>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link <?= $this->renderSection('dashboard') ?>" href="<?= base_url('/user') ?>">
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?= $this->renderSection('activetitle') ?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>OptiCare</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
